...
| Tool | What it does |
|------|-------------|
| `get_org_members(org_id)` | List staff members and their user IDs |
| `get_seeker_statuses(org_id)` | List available seeker pipeline statuses |
| `get_seeker_groups(org_id)` | List available seeker groups |
